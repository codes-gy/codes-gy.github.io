...
## 1. 흔히 저지르는 위험한 실수: `any` 타입 캐스팅과 컴파일 에러
...
## 2. 해결책 1: 선언 확장(Declaration Merging) 인터페이스 재정의


TypeScript의 강력한 기능 중 하나인 선언 확장(Declaration Merging)을 이용하면 Express 프레임워크 고유의 내장 글로벌 인터페이스를 안전하게 확장할 수 있습니다.
...
## 3. 해결책 2: 커스텀 Request 타입을 활용한 파이프라인 안전성 확보
